...
Services 可以缓存、投影、relay 和翻译链上事实，但不能成为 plans、orders、signals、hooks、attestations、funds、approvals、releases、refunds 或 disputes 的事实来源。默认规则是必须能从 contract events 重建。
