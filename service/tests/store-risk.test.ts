...
describe("Store risk graph no-op routes", () => {
  ...
  it("allows a private risk graph provider to be injected through the router", async () => {
    ...
    const router = createApiRouter(new MemoryProjectionStore(), { productRuntimeEnvironment: "local", submissionChainId: 84532, submissionVerifyingContract: "0x1111111111111111111111111111111111111111", riskGraphService: service });
