...
import type { StateMachineOrderProjection } from "../../indexer/projections/index.js";
import type { ProductOrderApiDTO, ProductService, ProductTaskApiDTO } from "../../product/application/service.js";
import type { ProjectionStore, ProjectionSyncState } from "../../storage/projection-store.js";
import type { StoreSupplierMetadataRecord, StoreSupplierMetadataStore } from "../suppliers/types.js";
