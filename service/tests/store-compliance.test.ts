...
describe("Store compliance no-op routes", () => {
  ...
  it("audits access-preview without raw payload, credential, object content, or signatures", async () => {
    ...
    const router = createApiRouter(new MemoryProjectionStore(), { productRuntimeEnvironment: "local", submissionChainId: 84532, submissionVerifyingContract: "0x1111111111111111111111111111111111111111", audit });
  ...
  it("allows a private compliance provider to be injected through the router", async () => {
    ...
    const router = createApiRouter(new MemoryProjectionStore(), { productRuntimeEnvironment: "local", submissionChainId: 84532, submissionVerifyingContract: "0x1111111111111111111111111111111111111111", complianceService: service });
